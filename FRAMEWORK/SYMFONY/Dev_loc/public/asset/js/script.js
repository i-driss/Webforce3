...
window.onload = () => {
    ...
    setTimeout(setInterval(chargeMessages, 20000), 5000)
...
function chargeMessages(){
        ...
        if (this.readyState == 4){
            if(this.status == 200){
                ...
                for(let message of messages){
                    ...
                    discussion.innerHTML += `<p>${message.userId.username} a écrit: ${message.content}</p>` 
    ...
    xmlhttp.open("GET","/message/recover"+lastid);
